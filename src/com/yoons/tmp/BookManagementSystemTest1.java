 ...
 * @since 		JDK 1.8
 */
public class BookManagementSystemTest1 {
	...
	public static void insertBookInfo() {
		...
		System.out.println("[성공] 입력 완료되었습니다.");
	...
	public static void updateBookInfo() {// Book book, int category) {
	...
	public static void deleteBookInfo() {// String category, String input) {
		...
		System.out.println("[성공] 삭제 성공되었습니다.");
		selectBookInfo(0, "");
	...
	public static String getInputString() {
		...
		try {
			...
			System.out.println("[오류] IOException 발생");
		}
		return str;
	}
